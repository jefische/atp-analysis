...
```{r games_won, echo=TRUE, eval=FALSE, warning=FALSE, message=FALSE}
matches$games_w <- NA
matches$games_l <- NA
...
```{r ELO, echo=TRUE, eval=FALSE, warning=FALSE, message=FALSE}
...
```{r ELO_top20, echo=TRUE, eval=FALSE, warning=FALSE, message=FALSE}
n=20
...
```{r YOY, echo=TRUE, eval=FALSE, warning=FALSE, message=FALSE}
...
```{r tourney, echo=TRUE, eval=FALSE}
...
```{r randomize, echo=TRUE, eval=FALSE}
set.seed(2016)
...
```{r gbm_caret, echo=TRUE, eval=FALSE}
